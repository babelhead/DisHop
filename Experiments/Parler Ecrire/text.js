...
function addText(){ //this works as a separate function in a separate file (see appendChile.html), but not working here, not sure why - possibly to do wiht the return/complete above?
    ...
    var node2 = document.createElement("p");
        ...
        document.getElementById("week29").appendChild(node1);
        document.getElementById("week29").appendChild(node2);
} 